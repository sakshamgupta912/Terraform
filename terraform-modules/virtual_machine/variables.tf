...
variable "vm_image_offer" {
  ...
  description = "Image Offer for the Publisher selected. Available options can be : UbuntuServer."
}
variable "vm_image_sku" {
  type        = string
  default     = "18.04-LTS"
  description = "Image Version or SKU for the publisher you have chosen. Such as 18.04-LTS, 20.04-LTS, etc."
}
...
variable "vm_subnetid" {
  type        = string
  default     = "/subscriptions/your_subscription_id/resourceGroups/myResourceGroup/providers/Microsoft.Network/virtualNetworks/myVnet/subnets/mySubnet"
